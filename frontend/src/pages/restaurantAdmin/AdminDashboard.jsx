...
const RestaurantAdminDashboard = () => {
  ...
  const handleAddMenuItem = async (e) => {
    ...
    try {
      await axios.post("http://0.0.0.0:1000/restaurant/menu", formData, {
        headers: {
  ...
  const handleEditMenuItem = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://0.0.0.0:1000/restaurant/menu/${selectedItem.id}`, formData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
          "Content-Type": "multipart/form-data",
        },
  ...
  const handleDeleteMenuItem = async (id) => {
    try {
      await axios.delete(`http://0.0.0.0:1000/restaurant/menu/${id}`, {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      });
      fetchMenuItems();
  ...
  const fetchProfile = async () => {
    try {
      const response = await axios.get(`http://0.0.0.0:1000/restaurant/profile/${restaurantId}`);
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      ...
      const url = profile.id ? `http://0.0.0.0:1000/restaurant/profile/${profile.id}` : "http://0.0.0.0:1000/restaurant/profile";
            ...
            <form onSubmit={handleProfileSubmit} className="space-y-6">
              ...
              <div>
                ...
                {profile.image && (
                  ...
                  (
                  <img
                    src={`http://0.0.0.0:1000/uploads/${profile.image}`}
                    alt="Restaurant"
        ...
        <img
          src={
            item.picture_url instanceof File
              ...
              : `http://0.0.0.0:1000/uploads/${item.picture_url}`
          }
          alt={item.name}
